...
const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <article
      className={`flex items-center justify-between rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm transition-colors duration-200 hover:border-blue-200 hover:shadow-md ${className}`.trim()}
    >
