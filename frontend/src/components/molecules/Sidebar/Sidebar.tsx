...
const teacherMenuItems = [
  { id: "dashboard", label: "Dashboard", icon: <Icon name="dashboard" />, href: "/dashboard" },
  { id: "courses", label: "Courses", icon: <Icon name="courses" />, href: "/dashboard/teacher/courses" },
  { id: "exams", label: "Exams", icon: <Icon name="exams" />, href: "/dashboard/teacher/exams/create" },
  { id: "students", label: "Students", icon: <Icon name="students" />, href: "/dashboard/teacher/students" },
  { id: "results", label: "Results", icon: <Icon name="results" />, href: "/dashboard/teacher/results" },
  { id: "certificates", label: "Certificates", icon: <Icon name="certificates" />, href: "/dashboard/teacher/certificates" },
];
